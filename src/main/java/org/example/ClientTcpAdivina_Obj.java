...
public class ClientTcpAdivina_Obj extends Thread {
    /* Clsient TCP que ha endevinar un número pensat per SrvTcpAdivina_Obj.java */
    ...
    public void run() {
        ...
        //Servidor Multicast UDP para recibir el tauler
        ClientMulticastUDP cvel = null;
        try {
            cvel = new ClientMulticastUDP(5557, "224.0.11.101");
            cvel.runClient();
        } catch (IOException e) {
